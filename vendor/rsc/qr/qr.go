...
import (
	...
	// Import rewriting is evil. Too bad code.google.com is shutting down.
	// Was: "code.google.com/p/rsc/qr/coding"
	"github.com/ironiridis/qrserv/vendor/rsc/qr/coding"
)
...
// L encoding is 20% redundant
// M encoding is 38% redundant
// Q encoding is 55% redundant
// H encoding is 65% redundant
const (
	L Level = iota
	M
	Q
